        ...
        <div className="flex flex-col gap-10 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-md text-sm leading-6 text-black/50">
              A simple workspace where teams collaborate, manage tasks,
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button className="ml-1 flex items-center gap-2 rounded-full bg-black px-5 py-2.5 text-sm font-medium text-white transition hover:bg-zinc-800">
              Go to Dashboard
