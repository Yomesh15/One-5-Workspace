    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(
                `${import.meta.env.VITE_BACKEND}/member/register`,
                form
            );
                ...
                >
                    ...
                    >
                        ...
                        <p className="mt-8 max-w-md text-base leading-7 text-zinc-400">
                            A focused workspace where teams can manage tasks,
                            collaborate effortlessly, and turn ideas into
                            meaningful work.
                        </p>
                    </motion.div>
                    ...
                    <div className="w-full max-w-md">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-lg font-semibold">One 5</span>
                            </div>
                        ...
                        >
                            ...
                            <h2 className="text-4xl font-semibold leading-tight tracking-tight sm:text-5xl">
                                ...
                                <span className="font-sekuya">workspace.</span>
                            </h2>

                            <p className="mt-4 text-sm leading-6 text-zinc-500">
                                Create your member account and start collaborating
                                with your team.
                            </p>
                        </motion.div>
